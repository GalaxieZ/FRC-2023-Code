...
public void tankDriveVoltsV2(double leftVolts, double rightVolts) {
  ...
  public double getRightEncoderPosition() {
    return ((double) (m_rightMaster.getSelectedSensorPosition() / 2048) / 8.4) * (Math.PI * .1524);
    // get rotations of encoder by dividing encoder counts by counts per rotation
    /*
  ...
  public void resetOdometry(Pose2d pose) {
    m_leftMaster.setSelectedSensorPosition(0);
    m_rightMaster.setSelectedSensorPosition(0);
    m_odometry.resetPosition(m_gyro.getRotation2d(), getAverageEncoderDistance(), getAngle(), pose);
  }
  //
...
public static void setDefaultCommand(XboxController mDrivercontroller) {
}
}
